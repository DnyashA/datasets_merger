...
class Merger(object):
    ...
    def __init__(self, main_dat_path, sub_dat_path, mainmarkup, submarkup, save_path, npy=False, shuffle=False, split=False):
        ...
        self.main_markup = mainmarkup
        # .csv file which should be merged with standard
        self.sub_markup = submarkup
